  ...
  const projects = [
    {
      title: "MyCpTrainer",
      description:
        "Founder of MyCPTrainer — an intelligent platform empowering programmers to level up in competitive programming with data-driven insights and tailored practice.",
      tags: ["Typescript", "NextJS", "Sentry", "PostgreSQL", "RabbitMQ"],
      codeLink: null,
